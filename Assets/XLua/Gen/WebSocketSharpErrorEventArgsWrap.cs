...
namespace XLua.CSObjectWrap
{
    ...
    public class WebSocketSharpErrorEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WebSocketSharp.ErrorEventArgs);
        ...
        {
            return LuaAPI.luaL_error(L, "WebSocketSharp.ErrorEventArgs does not have a constructor!");
        }
        ...
        static int _g_get_Exception(RealStatePtr L)
        {
		    try {
                ...
                WebSocketSharp.ErrorEventArgs gen_to_be_invoked = (WebSocketSharp.ErrorEventArgs)translator.FastGetCSObj(L, 1);
