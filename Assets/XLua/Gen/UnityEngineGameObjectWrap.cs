...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 8, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DownloadBytes", _m_DownloadBytes);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "HTTPPostJsonText", _m_HTTPPostJsonText);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetActiveAllChild", _m_SetActiveAllChild);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DestroyAllChild", _m_DestroyAllChild);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DownloadBytes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    BabyEngine.CacheOption _cache;translator.Get(L, 3, out _cache);
                    System.Action<int, System.Collections.Generic.Dictionary<string, string>, byte[]> _cb = translator.GetDelegate<System.Action<int, System.Collections.Generic.Dictionary<string, string>, byte[]>>(L, 4);
                    
                    gen_to_be_invoked.DownloadBytes( _url, _cache, _cb );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_HTTPPostJsonText(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Action<int, System.Collections.Generic.Dictionary<string, string>, string> _cb = translator.GetDelegate<System.Action<int, System.Collections.Generic.Dictionary<string, string>, string>>(L, 4);
                    
                    gen_to_be_invoked.HTTPPostJsonText( _url, _data, _cb );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetActiveAllChild(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetActiveAllChild( _b );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DestroyAllChild(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DestroyAllChild(  );
