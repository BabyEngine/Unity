...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineNetworkingUnityWebRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 8, 22, 12);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetCacheable", _m_SetCacheable);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetCacheable(RealStatePtr L)
        {
		    try {
                ...
                {
                    BabyEngine.CacheOption _option;translator.Get(L, 2, out _option);
                    
                        BabyEngine.CacheableDownloadHandler gen_ret = gen_to_be_invoked.SetCacheable( _option );
                        translator.Push(L, gen_ret);
