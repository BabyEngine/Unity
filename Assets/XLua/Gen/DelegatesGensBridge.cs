...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(int p0, System.Collections.Generic.Dictionary<string, string> p1, byte[] p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp2(int p0, System.Collections.Generic.Dictionary<string, string> p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<int, System.Collections.Generic.Dictionary<string, string>, byte[]>))
			{
			    return new System.Action<int, System.Collections.Generic.Dictionary<string, string>, byte[]>(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(System.Action<int, System.Collections.Generic.Dictionary<string, string>, string>))
			{
			    return new System.Action<int, System.Collections.Generic.Dictionary<string, string>, string>(__Gen_Delegate_Imp2);
			}
